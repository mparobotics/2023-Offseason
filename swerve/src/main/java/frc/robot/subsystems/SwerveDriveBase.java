...
public class SwerveDriveBase {
    ...
    public WPI_Pigeon2 pigeon = new WPI_Pigeon2(DriveConstants.GYRO_ID);
    ...
    public SwerveDriveBase(){
        ...
        wheel1 = new SwerveModule(DriveConstants.DRIVE_ID_1, DriveConstants.TURN_ID_1,DriveConstants.ENCODER_1,wheel1pos);
        wheel2 = new SwerveModule(DriveConstants.DRIVE_ID_2, DriveConstants.TURN_ID_2,DriveConstants.ENCODER_2, wheel2pos);
        wheel3 = new SwerveModule(DriveConstants.DRIVE_ID_3, DriveConstants.TURN_ID_3,DriveConstants.ENCODER_3, wheel3pos);
        wheel4 = new SwerveModule(DriveConstants.DRIVE_ID_4, DriveConstants.TURN_ID_4,DriveConstants.ENCODER_4,wheel4pos);
    ...
    */
    ...
    public SequentialCommandGroup followTrajectory(SwerveDriveBase swerve, String filepath){
      //trajectory object
      ...
      PIDController Xpid = new PIDController(TrajectoryConstants.kP_X, 0, 0);
      PIDController Ypid = new PIDController(TrajectoryConstants.kP_Y, 0, 0);
      ProfiledPIDController Dpid = new ProfiledPIDController(TrajectoryConstants.kP_D, 0, 0,null);
      Dpid.enableContinuousInput(0, 2 * Math.PI);
      
      //creates the swerve controller command using the generated trajectory
